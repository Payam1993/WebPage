      ...
      <div className="erotic-container">
        <div className="erotic-footer-top">
          ...
          <div className="erotic-footer-brand">
            <div className="erotic-footer-logo">
            ...
            <div className="erotic-footer-col">
              ...
              <ul>
                {t.footer.company.map((item, i) => (
                  <li key={i}><a href="#about">{item}</a></li>
                ))}
              </ul>
            </div>
            <div className="erotic-footer-col">
              ...
              <ul>
                {t.footer.support.map((item, i) => (
                  <li key={i}><a href="#booking">{item}</a></li>
                ))}
              </ul>
            </div>
          </div>
          ...
          <div className="erotic-footer-contact">
            <h4>Contact</h4>
            <div className="erotic-contact-item">
              <a href="tel:+34678902765">+34 678 902 765</a>
            </div>
            <div className="erotic-contact-item">
              <a href="https://wa.me/34678902765" target="_blank" rel="noopener noreferrer">
                WhatsApp
              </a>
            </div>
        ...
        <div className="erotic-footer-bottom">
          <p>&copy; {currentYear} Confession Erotic. {t.footer.copyright}</p>
          <button className="erotic-back-to-top" onClick={scrollToTop}>
