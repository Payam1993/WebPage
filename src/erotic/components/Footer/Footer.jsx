      ...
      <div className="erotic-container">
        <div className="erotic-footer-top">
          ...
          <div className="erotic-footer-contact">
            ...
            <div className="erotic-contact-item">
              <a href="https://wa.me/34691846476" target="_blank" rel="noopener noreferrer">
                WhatsApp
              </a>
            </div>
            <div className="erotic-footer-social">
              <a href="https://wa.me/34691846476" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
